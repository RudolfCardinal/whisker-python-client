...
latex_documents = [
    (master_doc, 'whisker.tex', 'whisker Documentation',
...
man_pages = [
    (master_doc, 'whisker', 'whisker Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'whisker', 'whisker Documentation',
     author, 'whisker', 'One line description of project.',
     'Miscellaneous'),
]
